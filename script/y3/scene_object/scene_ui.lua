...
function scene_ui.get_lua_scene_ui_from_py(player,py_scene_ui)
...
function scene_ui.create_scene_ui_at_point(sceneui,point,range,height)
    return game_api.create_scene_node_on_point(sceneui, point.base(), range, height)
end
...
function scene_ui.create_scene_ui_at_player_unit_socket(scene_ui_type,player,unit,socket_name,distance)
    local py_scene_ui = game_api.create_scene_node_on_unit(scene_ui_type,player.base(),unit.base(),socket_name,distance)
    return y3.scene_ui.get_lua_scene_ui_from_py(player,py_scene_ui)
end
